          ...
          <div className="flex flex-col items-start">
            ...
            <div className="flex items-center gap-4">
              <a 
                ...
                target="_blank" 
                rel="noreferrer" 
                className="w-10 h-10 border border-white/10 flex items-center justify-center text-outline hover:text-white hover:border-white/30 transition-all duration-300"
