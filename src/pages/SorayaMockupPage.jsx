...
const OperationAllgasmSvg = () => (
  <svg viewBox="0 0 160 160" className="w-full h-full object-cover">
    {/* Background color (warm brown/beige) */}
    <rect width="100%" height="100%" fill="#784B3E" />
    {/* Silhouettes of items */}
...
export default function SorayaMockupPage() {
  ...
  return (
    <div className="min-h-screen bg-[#111111] text-[#E5E2E1] font-sans flex items-center justify-center p-0 md:p-8">
      <Helmet>
      ...
      {/* Main Grid Wrapper */}
      <div className="w-full max-w-6xl grid grid-cols-1 lg:grid-cols-[1fr_420px] gap-8 items-center">
        
        {/* DESKTOP LEFT SIDE: Description and Mockup Control */}
        <div className="hidden lg:flex flex-col justify-center pr-8 space-y-6">
          <span className="text-[11px] font-bold tracking-[0.2em] text-[#FF5C3F] uppercase">
            ВЕБ-МАКЕТ ИНТЕРФЕЙСА
          </span>
          <h1 className="text-[42px] font-bold tracking-tight text-white leading-none font-display uppercase">
            SORAYA WAVE™
          </h1>
          <p className="text-gray-400 text-sm leading-relaxed">
            Это интерактивный прототип мобильной версии страницы продукта для интернет-магазина **HOT STUFF**. 
            Мы объединили структуру блоков с изображений `image_17.png` и `image_18.png` в единый длинный прокручиваемый шаблон.
          </p>
          <div className="h-px bg-white/10 w-24" />
          <ul className="space-y-3 text-xs text-gray-400">
            <li className="flex items-center gap-2">
              <span className="w-1.5 h-1.5 rounded-full bg-[#FF5C3F]" />
              Стандартный статус-бар iOS сверху
            </li>
            <li className="flex items-center gap-2">
              <span className="w-1.5 h-1.5 rounded-full bg-[#FF5C3F]" />
              Раздвижные блоки описаний и гарантий
            </li>
            <li className="flex items-center gap-2">
              <span className="w-1.5 h-1.5 rounded-full bg-[#FF5C3F]" />
              Наборы товаров «КУПИ НАБОР И СЭКОНОМЬ» снизу
            </li>
            <li className="flex items-center gap-2">
              <span className="w-1.5 h-1.5 rounded-full bg-[#FF5C3F]" />
              Интерактивный выбор цветов и слайдер картинок
            </li>
          </ul>
          ...
          <div className="pt-4">
            <button 
              ...
              className="border border-white/20 hover:border-white px-6 py-3 text-xs font-bold tracking-widest text-white uppercase transition-colors"
            >
              ВЕРНУТЬСЯ В КАТАЛОГ
            </button>
          </div>
        ...
        {/* MOCKUP CONTAINER (iPhone Frame Shell on Desktop) */}
        <div className="flex justify-center items-center w-full">
          <div className="relative bg-[#1a1a1a] p-3 rounded-[48px] shadow-2xl border-4 border-[#333333] w-full max-w-[390px] aspect-[9/19.5] flex flex-col overflow-hidden">
            ...
            <div className="absolute top-4 left-1/2 -translate-x-1/2 w-28 h-6 bg-black rounded-full z-50 flex items-center justify-center">
              <div className="w-2.5 h-2.5 bg-[#0a0a0a] rounded-full absolute left-4" />
              <div className="w-1.5 h-1.5 bg-[#080808] rounded-full absolute right-6" />
            </div>

            {/* iOS Status Bar */}
            <div className="h-10 bg-black text-white px-6 flex justify-between items-center text-[10px] font-bold select-none z-40 relative flex-none">
              <div>00:27 🛌</div>
              <div className="flex items-center gap-1.5">
                ...
                <div className="border border-white/40 rounded-[3px] px-1 py-0.5 text-[8px] leading-none flex items-center justify-center">
                  77
                </div>
              </div>
            </div>

            {/* SCROLLABLE MOCKUP SCREEN */}
            <div className="flex-1 bg-white text-black overflow-y-auto select-none font-sans scroll-smooth">
              ...
              <section className="relative bg-white py-8 flex flex-col items-center">
                ...
                <div className="w-[85%] h-[2.5px] bg-gray-200 mt-6 relative">
                  <div 
            ...
            <div className="h-6 bg-black flex items-center justify-center flex-none">
